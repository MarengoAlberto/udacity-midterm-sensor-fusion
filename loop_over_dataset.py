...
exsercise_id = 'ID_S4_EX2'

if exsercise_id == 'ID_S1_EX1':
    sequence = 1
    show_only_frames = [0, 1]
    exec_detection = []
    exec_tracking = []
    exec_visualization = ['show_range_image']
elif exsercise_id == 'ID_S1_EX2':
    sequence = 3
    show_only_frames = [0, 200]
    exec_detection = []
    exec_tracking = []
    exec_visualization = ['show_pcl']
elif exsercise_id == 'ID_S2_EX1':
    sequence = 1
    show_only_frames = [0, 1]
    ...
    raise ValueError('Exercise ID not recognized')
...
if sequence == 1:
    ...
    raise ValueError('Sequence number not recognized')
